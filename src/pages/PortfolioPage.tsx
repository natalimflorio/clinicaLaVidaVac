  ...
  return (
    <div className="min-h-screen font-sans selection:bg-orange-100" style={{ backgroundColor: COLORS.bg, color: COLORS.text }}>
      ...
      <header className="pt-32 pb-16 px-6 max-w-6xl mx-auto text-center">
        ...
        >
          <h1 className="text-7xl md:text-9xl font-bold tracking-tight leading-none" style={{ color: COLORS.blue }}>
            Bem-estar Corporativo
          </h1>
          <p className="text-4xl md:text-5xl font-medium tracking-wide mt-4" style={{ color: COLORS.green }}>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl font-bold tracking-tight" style={{ color: COLORS.text }}>
              Por que escolher a <span style={{ color: COLORS.blue }}>Vacinaslavida</span>?
            </h3>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4" style={{ color: COLORS.blue }}>Alguns de Nossos Clientes</h2>
            <p className="text-lg text-gray-500">Atendemos diversas empresas, promovendo bem-estar e aumentando a produtividade.</p>
          </div>
          
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            {/* Using placeholder logos for demonstration */}
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="w-32 h-16 flex items-center justify-center font-bold text-2xl text-gray-400">
                CLIENTE {i}
              </div>
            ))}
          </div>
      ...
      <footer className="px-6 py-16 border-t border-gray-100" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 text-gray-600">
              ...
              <span>Rua Costa Aguiar, 1969 - Ipiranga<br />São Paulo - SP</span>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto mt-16 pt-8 border-t border-gray-50 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Vacinaslavida - Saúde e Bem Estar. Todos os direitos reservados.</p>
        </div>
      </footer>
    </div>
  );
